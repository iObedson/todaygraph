...
<head>
  ...
  <title><?php echo $post['title']; ?> | <span>D</span>i<span>YNoW.W</span>i<span>N</span></title>
</head>
      ...
      <div class="sidebar single">
        ...
        <div class="fb-page" data-href="https://web.facebook.com/codingpoets/" data-small-header="false"
          ...
          <blockquote cite="https://web.facebook.com/codingpoets/" class="fb-xfbml-parse-ignore"><a
              href="<?php echo BASE_URL . '/index.php'; ?>">Place ads here </a></blockquote>
        </div>
        ...
        <div class="section popular">
          ...
          <?php foreach ($posts as $post): ?>
            ...
            <img src="<?php echo BASE_URL . '/assets/images/' . $post['image']; ?>" alt="" class="post-image"></a>
              <a href="" class="title">
